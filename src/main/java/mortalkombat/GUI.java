...
public class GUI extends javax.swing.JFrame {
    ...
    public GUI() {
        ...
        playerIconLabel.setIcon(new ImageIcon("src/images/fighter.png"));
    ...
    private void initComponents() {
        ...
        blockButton.setBackground(new java.awt.Color(188, 204, 86));
        ...
        playerDamageValueLabel.setForeground(new java.awt.Color(99, 34, 37));
        ...
        enemyDamageValueLabel.setForeground(new java.awt.Color(99, 34, 37));
        ...
        fightLabel.setForeground(new java.awt.Color(45, 45, 168));
        ...
        playerHealthLabel.setForeground(new java.awt.Color(69, 65, 65));
        ...
        enemyHealthLabel.setForeground(new java.awt.Color(69, 65, 65));
        ...
        experinceTitleLabel.setForeground(new java.awt.Color(81, 66, 41));
        ...
        pointsTitleLabel.setForeground(new java.awt.Color(81, 66, 41));
        ...
        experienceValueLabel.setForeground(new java.awt.Color(81, 66, 41));
        ...
        pointsValueLabel.setForeground(new java.awt.Color(81, 66, 41));
        ...
        enemyActionLabel.setForeground(new java.awt.Color(205, 35, 35));
        ...
        itemsButton.setBackground(new java.awt.Color(122, 128, 79));
        ...
        debuffButton.setBackground(new java.awt.Color(53, 53, 152));
        ...
        endFightPanel.setBackground(new java.awt.Color(149, 179, 174));
        ...
        endRoundLabel.setForeground(new java.awt.Color(94, 13, 13));
        ...
        nextRoundButton.setBackground(new java.awt.Color(172, 213, 183));
        ...
        endGamePanel.setBackground(new java.awt.Color(240, 217, 248));
        ...
        enterNameLabel.setForeground(new java.awt.Color(64, 61, 61));
        ...
        enterNameLabelBottom.setForeground(new java.awt.Color(64, 61, 61));
        enterNameLabelBottom.setText("результата в таблицу рекордов");

        endGameButton.setBackground(new java.awt.Color(89, 89, 236));
        endGameButton.setFont(new java.awt.Font("Comic Sans MS", 1, 14)); // NOI18N
        endGameButton.setForeground(new java.awt.Color(64, 61, 61));
        ...
        recordsTablePanel.setBackground(new java.awt.Color(99, 116, 142));
        ...
        itemsBagPanel.setBackground(new java.awt.Color(222, 213, 162));

        itemsBagLabel.setFont(new java.awt.Font("Comic Sans MS", 0, 16)); // NOI18N
        itemsBagLabel.setForeground(new java.awt.Color(38, 35, 35));
        itemsBagLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        itemsBagLabel.setText("Мешок предметов");

        firstItemButton.setBackground(new java.awt.Color(222, 213, 162));
        ...
        secondItemButton.setBackground(new java.awt.Color(222, 213, 162));
        ...
        useItemButton.setBackground(new java.awt.Color(173, 156, 65));
        ...
        cantUseItemPanel.setBackground(new java.awt.Color(154, 156, 252));

        cantUseItemLabel.setFont(new java.awt.Font("Comic Sans MS", 1, 18)); // NOI18N
        cantUseItemLabel.setForeground(new java.awt.Color(38, 35, 35));
        ...
        unavailableItemLabel.setForeground(new java.awt.Color(38, 35, 35));
        ...
        closeCantUseItemButton.setForeground(new java.awt.Color(38, 35, 35));
        ...
        mkLabel.setForeground(new java.awt.Color(144, 222, 232));
        mkLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        mkLabel.setIcon(new ImageIcon("src/images/Kombat.jpg"));
        ...
        panelLayout.setHorizontalGroup(
                panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(panelLayout.createSequentialGroup()
                                .addGap(159, 159, 159)
                                .addComponent(mkLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        panelLayout.setVerticalGroup(
                panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(panelLayout.createSequentialGroup()
                                .addGap(54, 54, 54)
                                .addComponent(mkLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE)
